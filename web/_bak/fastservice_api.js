...
async function signIn(usuario_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/login/" + usuario_id, {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readUsuariosContatos(usuario_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/contatos", {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readUsuariosEnderecos(usuario_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/enderecos", {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function cadastraServicos(usuario_id, form_servicoDto) {
 ...
 // }
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/servicos", {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readMarketplace(usuario_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/servicos/marketplace", {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readUsuariosServicos(usuario_id, servico_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/servicos/" + servico_id, {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readPedidos(usuario_id, pedido_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/pedidos/" + pedido_id, {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readPedidosCliente(usuario_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/pedidos/cliente", {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function readPedidosProfissional(usuario_id) {
 let response = await fetch(
  fastservice_url + "/usuarios/" + usuario_id + "/pedidos/profissional", {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",
   },
...
async function updateProfissionalPedidosDisponibilidades(
 usuario_id,
 pedido_id,
...
async function updateClientePedidosDisponibilidades(
 usuario_id,
 pedido_id,
 disponibilidade_id
) {
...
async function updateClientePedidosAvaliar(
 usuario_id,
 pedido_id,
 notaAvaliacao
) {
...
async function readPedidosByFilter(usuario_id, tipoServico) {
 ...
 let response = await fetch(
  ...
  "/usuarios/" +
  usuario_id +
  "/pedidos/filtrar?servicofinalizado=" +
  tipoServico, {
   headers: {
    Accept: "application/json",
    "Content-Type": "application/json",

...
Esse é um produto da disciplina de Projeto Integrador II, do curso de Análise e Desenvolvimento de Sistemas, do Centro Universitário de São José. O objetivo nessa disciplina é desenvolver um MVP (Minimum Viable Product). O propósito dessa aplicação é funcionar como um hub para oferecer e solicitar serviços (basicamente um marketplace).
